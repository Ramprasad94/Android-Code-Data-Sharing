...
public class PrivateImagesActivity extends ListActivity {
	...
	protected void alertbox(String title,final String imagePath, final int pos)
	   {
		 ...
		 AlertDialog.Builder builder = new AlertDialog.Builder(PrivateImagesActivity.this);
      ...
      public void onClick(DialogInterface dialog, int item) {
          ...
          switch(item)
          {
              case 0:
                 ...
                 Intent it=new Intent(PrivateImagesActivity.this,TabViewDownload.class);
            	  startActivity(it);
		 ...
		 String filepath = "/sdcard/AWS/aws";
			...
			if(file.exists()==false){
		    	 ...
		    	 ContentValues values = new ContentValues(7);
		    	   values.put(Images.Media.TITLE, al.get(posi).toString().trim());
		    	   values.put(Images.Media.DISPLAY_NAME, al.get(posi).toString().trim());
		    	   ...
		    	   values.put("_data", filepath + al.get(posi).toString().trim());
		    	   
		    	   ContentResolver contentResolver = getApplicationContext().getContentResolver();
		    	   Uri uri = contentResolver.insert(Images.Media.EXTERNAL_CONTENT_URI, values);
		    	   System.out.println("uriiiiiiiiiiiiiiiiiiiiiiiiii    "+uri);
				...
				Toast.makeText(getApplicationContext(), "Downloaded sucessfully", 190).show();
