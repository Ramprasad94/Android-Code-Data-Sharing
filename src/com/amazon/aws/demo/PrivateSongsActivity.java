...
public class PrivateSongsActivity extends ListActivity {
	...
	protected void alertbox(String title,final String imagePath, final int pos){
		final CharSequence[] items = {"delete", "download"};
		 ...
		 AlertDialog.Builder builder = new AlertDialog.Builder(PrivateSongsActivity.this);
     ...
     public void onClick(DialogInterface dialog, int item) {
         ...
         switch(item)
         {
             case 0:
                ...
                Intent it=new Intent(PrivateSongsActivity.this,TabViewDownload.class);
           	  startActivity(it);
		...
		System.out.println("@@@@@@@@@@@@@@@@@@@@"+is);
		 ...
		 if(file.exists()==false){
	    	 ...
	    	 values.put(MediaStore.Audio.Media.IS_MUSIC, false);  
	    	   ...
	    	   Uri uri = contentResolver.insert(MediaStore.Audio.Media.getContentUriForPath(filepath+ al.get(posi).toString().trim()), values);  
