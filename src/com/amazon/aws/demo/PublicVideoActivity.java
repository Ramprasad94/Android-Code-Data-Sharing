...
public class PublicVideoActivity extends ListActivity {
				...
				public void onItemClick(AdapterView<?> parent, View view,
					...
					System.out.println("@@@@@@@@@@@@@@@@@@@@"+is);
					 ...
					 if(file.exists()==false){
				    	 ...
				    	 values.put(MediaStore.MediaColumns.MIME_TYPE, "video/"+al.get(position).toString().substring(al.get(position).toString().lastIndexOf("."))+"");  
